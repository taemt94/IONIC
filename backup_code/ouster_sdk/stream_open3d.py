...
def viewer_3d(scans: client.Scans, stop_event=None, paused: bool = False) -> None:
    ...
    # create geometries
    axes = o3d.geometry.TriangleMesh.create_coordinate_frame(0.1)
    ...
    try:
        ...
        ctr.set_zoom(0.5[[]])
        view_from(vis, np.array([-5, 0, 5]), np.array([2, 0, 0.5]))
