...
if __name__ == "__main__":
    with open("/home/tskim/tskim/lidar_test/2022_11_18_16_25_11_os-122211003068.json", "r") as f:
        metadata = client.SensorInfo(f.read())
    source = pcap.Pcap("/home/tskim/tskim/lidar_test/2022_11_18_16_25_11_os-122211003068.local.pcap", metadata)
    
    with closing(source):
        pcap_to_pcd(source, metadata, )